...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#mypage').on('click', function() {
			$(location).attr('href', 'views/mypage.jsp');
		});
		
		$('#searchBtn').on('click', function() {
			$(location).attr('href', 'views/search.jsp');
		});
	});
...
<body id="page-top">
  ...
  <div class="container">
  	...
  	항상 쌉방 서비스를 이용해주시는 이용자 여러분께 진심으로 감사드리며,<br>
  	개인정보 처리방침 개정에 대한 사전 안내 말씀 드립니다.<br><br>
  	
  	이용자분께서는 변경되는 개인정보 처리방침 내용을 확인해주시기를 부탁 드립니다.<br><br>
  	
  	항상 쌉방을 이용해 주시는 여러 이용자분들께 감사의 말씀 드리며, 앞으로도 더 나은 서비스를 제공드리도록 노력하겠습니다.<br>
  	</div>
	<hr/>
	<div class="button" style="float:right;">
	<input type="button" class="btn btn-primary justify-content-center" value="목록" onclick="location.href='board.jsp'">
	</div>
	<br><br>
</div>
